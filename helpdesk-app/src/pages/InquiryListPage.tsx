...
export const InquiryListPage = ({ inquiries, onSelectInquiry, onDeleteInquiry, lang }: InquiryListPageProps) => {
  ...
  return (
    <div>
      <div className="eo-filter-panel">
        <span className="eo-filter-title">{t.sub}</span>
      ...
      <div style={{ marginTop: "15px", borderTop: "1px solid #29184a", paddingTop: "10px" }}>
